...
import com.gama.gama.servicio.ComentarioServicio;
...
public class ComentarioControlador {
    ...
    public ResponseEntity<ComentarioDTO> actualizarComentarioPorId(@PathVariable(value = "publicacionId") Long publicacionId,@PathVariable(value = "id") Long comentarioId,@Valid @RequestBody ComentarioDTO comentarioDTO){
